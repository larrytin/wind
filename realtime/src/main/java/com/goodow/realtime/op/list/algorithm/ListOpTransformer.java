 ...
 * the License.
 */
package com.goodow.realtime.op.list.algorithm;

import static com.goodow.realtime.op.list.algorithm.ListOpComposer.initialDocumentLength;

import com.goodow.realtime.op.TransformException;
import com.goodow.realtime.op.list.algorithm.ListOpComposer.Target;
