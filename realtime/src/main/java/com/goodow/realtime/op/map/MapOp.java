 ...
 * the License.
 */
package com.goodow.realtime.op.map;

import com.goodow.realtime.op.ComposeException;
import com.goodow.realtime.op.Op;
import com.goodow.realtime.op.TransformException;
...
public class MapOp implements Op<MapTarget>, MapTarget {
  ...
  @Override
  public MapOp composeWith(Op<MapTarget> op) {
  ...
  @Override
  public Pair<MapOp, MapOp> transformWith(Op<?> clientOp) {
