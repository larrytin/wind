 ...
 * the License.
 */
package com.goodow.realtime.op.list;

import com.goodow.realtime.op.list.algorithm.ListHelper;
import com.goodow.realtime.op.list.algorithm.ListNormalizer;
import com.goodow.realtime.op.list.algorithm.ListNormalizer.Appender;
