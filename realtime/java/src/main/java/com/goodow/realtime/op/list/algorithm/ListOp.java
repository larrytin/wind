...
public abstract class ListOp<T> implements Op<ListTarget<T>>, ListTarget<T> {
  enum ComponentType {
  ...
  @Override
  public ListOp<T> composeWith(Op<ListTarget<T>> op) {
  ...
  @Override
  public Pair<? extends ListOp<T>, ? extends ListOp<T>> transformWith(Op<?> clientOp) {
